...
export function DocsGlobalSchema({ language, topic }: TopicProps) {
	...
	return (
		<Article title="Schema">
			<div>
				<p>
					Since you have already connected to a SurrealDB instance and defined user
					credentials, you can now specify the schema in your database. The schema
					contains the tables, relationships, and indexes that are used to store and
					retrieve data which define the structure of the data that is stored in the
					database and the relationships between the different tables in the database.
				</p>
			</div>
			<Box>
				<DocsPreview
