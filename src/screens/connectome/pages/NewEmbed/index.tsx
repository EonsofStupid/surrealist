...
import { Icon, iconCheck, iconClose, iconTransfer, iconXml } from "@rrflow/ui";
							...
							<Stack gap="xl">
								...
								<Paper p="xl">
									<Text
										...
										c="bright"
									>
										Integrate your Connectome Mini
									</Text>
									<Text>
										Copy your Connectome Mini as an embeddable iframe snippet or
										as direct URL
									</Text>
									<SimpleGrid
										cols={2}
