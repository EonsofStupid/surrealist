...
import tier4DarkUrl from "~/shared/assets/images/dark/referral-tier-4.png";
import tier5DarkUrl from "~/shared/assets/images/dark/referral-tier-5.png";
import tier1LightUrl from "~/shared/assets/images/light/referral-tier-1.png";
import tier2LightUrl from "~/shared/assets/images/light/referral-tier-2.png";
import tier3LightUrl from "~/shared/assets/images/light/referral-tier-3.png";
						...
						<Box mt={36}>
							...
							<Progress
								...
								styles={{
									...
									section: {
										background: "var(--Connectome-gradient)",
										boxShadow: "var(--Connectome-glow)",
									},
								}}
							/>
						</Box>
