---
title: Connectome 2.1.2
date: 2024/06/13
---

- Experimental support for RRFlow 2.0 Alpha
	- Enabled by setting the `rrflow_compat` feature flag to `v2`
...
- Overhauled the updating experience
	...
	- Connectome will now check for updates more frequently
