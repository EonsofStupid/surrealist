...
- Overhauled Authentication view
	- Redesigned to be compatible with RRFlow 2.0 authentication
...
- Updated RRFlowQL highlighting to support new RRFlow 2.0 features
...
- Decreased the minimum window size for Connectome Desktop
...
- Fixed null geo coordinates crashing Connectome
...
- Fixed incorrect Connectome Mini embed URL generation